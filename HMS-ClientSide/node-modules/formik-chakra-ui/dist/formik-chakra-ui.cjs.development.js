...
var FormControl = function FormControl(props) {
  ...
  }, rest), label && typeof label === 'string' ? React__default.createElement(react.FormLabel, Object.assign({
    htmlFor: name
  }, labelProps), label) : label, children, error && React__default.createElement(react.FormErrorMessage, Object.assign({}, errorMessageProps), error), helperText && typeof helperText === 'string' ? React__default.createElement(react.FormHelperText, Object.assign({}, helperTextProps), helperText) : helperText);
};
