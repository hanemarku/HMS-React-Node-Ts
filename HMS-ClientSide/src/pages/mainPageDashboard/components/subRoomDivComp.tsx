...
export const SubRoomDivContainer:React.FC<RoomListProps> = ({data, title, h1 , span})  => {
            ...
            <div className="container">
                ...
                <div className="row g-4">
                    {data && data.map((entity) => (
                        <div  key={entity.id + 100} className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div style={{backgroundColor: "white"}} className="room-item shadow rounded overflow-hidden">
                                ...
                                <div className="p-4 mt-2">
                                    ...
                                    <div className="d-flex justify-content-center">
                                        <a className="btn btn-sm btn-primary rounded py-2 px-4"  onClick={() => handleRoomDetails(entity.id)}>View
                                            Detail</a>
                                    </div>
                                </div>
                            </div>
